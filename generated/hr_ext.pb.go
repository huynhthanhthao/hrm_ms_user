...
const file_proto_hr_ext_proto_rawDesc = "" +
	...
	"\n" +
	"ExtService\x12C\n" +
	"\x11GetBranchByUserId\x12\x1f.entpb.GetBranchByUserIdRequest\x1a\r.entpb.BranchB\rZ\v./generatedb\x06proto3"

var (
	file_proto_hr_ext_proto_rawDescOnce sync.Once
	file_proto_hr_ext_proto_rawDescData []byte
)

func file_proto_hr_ext_proto_rawDescGZIP() []byte {
	file_proto_hr_ext_proto_rawDescOnce.Do(func() {
		file_proto_hr_ext_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_hr_ext_proto_rawDesc), len(file_proto_hr_ext_proto_rawDesc)))
	})
	return file_proto_hr_ext_proto_rawDescData
}

var file_proto_hr_ext_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func init() { file_proto_hr_ext_proto_init() }
func file_proto_hr_ext_proto_init() {
	if File_proto_hr_ext_proto != nil {
		return
	}
	file_proto_hr_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_proto_hr_ext_proto_goTypes,
		DependencyIndexes: file_proto_hr_ext_proto_depIdxs,
		MessageInfos:      file_proto_hr_ext_proto_msgTypes,
	}.Build()
	File_proto_hr_ext_proto = out.File
	file_proto_hr_ext_proto_goTypes = nil
	file_proto_hr_ext_proto_depIdxs = nil
}

...
const (
	ExtService_GetEmployeeByUserId_FullMethodName    = "/hr.ExtService/GetEmployeeByUserId"
	ExtService_DeleteEmployeeByUserId_FullMethodName = "/hr.ExtService/DeleteEmployeeByUserId"
)

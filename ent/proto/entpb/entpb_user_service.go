...
func toProtoUser_Gender(e user.Gender) User_Gender {
	if v, ok := User_Gender_value[strings.ToUpper("GENDER_"+protoIdentNormalizeUser_Gender(string(e)))]; ok {
		return User_Gender(v)
	}
	return User_Gender(0)
}

func toEntUser_Gender(e User_Gender) user.Gender {
	if v, ok := User_Gender_name[int32(e)]; ok {
